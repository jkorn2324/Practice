...
namespace jkorn\practice\games\duels\player;
...
use jkorn\practice\games\duels\player\properties\PropertyInfo;
use jkorn\practice\games\duels\player\properties\types\FloatDPProperty;
use jkorn\practice\games\duels\player\properties\types\IntegerDPProperty;
...
class DuelPlayer
{
    ...
    /** @var bool */
    private $dead = false, $online = true;
    ...
    public function equals($player): bool
    {
        ...
        elseif ($player instanceof DuelPlayer)
        {
