...
namespace old\practice\duels\groups;

use pocketmine\block\Block;
use pocketmine\level\Position;
use pocketmine\Player;
use pocketmine\utils\TextFormat;
use old\practice\arenas\DuelArena;
use old\practice\duels\misc\DuelInvInfo;
use old\practice\duels\misc\DuelPlayerHit;
use old\practice\duels\misc\DuelSpectator;
...
class DuelGroup
{
    ...
    /**
     * @return \old\practice\player\PracticePlayer|null
     */
