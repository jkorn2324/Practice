...
class YellowDefault extends ArenaGenerator implements ColorIDs
{
    ...
    {
        $this->blocks = [
            Block::get(Block::CONCRETE, self::BLOCK_COLOR_YELLOW),
            Block::get(Block::CONCRETE, self::BLOCK_COLOR_YELLOW),
            Block::get(Block::WOOL, self::BLOCK_COLOR_YELLOW),
            Block::get(Block::WOOL, self::BLOCK_COLOR_YELLOW),
            Block::get(Block::STAINED_GLASS, self::BLOCK_COLOR_YELLOW)
        ];
    }
